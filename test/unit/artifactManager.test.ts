  ...
  it("blocks artifact URLs that point to non-allowlisted repositories", async () => {
    ...
    const manifest = {
      ...
      artifacts: {
        ...
        uiHints: {
          url: "https://raw.githubusercontent.com/nilsjorek/openclaw-config-vscode/main/openclaw.ui-hints.json",
          sha256: "b".repeat(64),
        },
        validator: {
          url: "https://raw.githubusercontent.com/nilsjorek/openclaw-config-vscode/main/openclaw.validator.mjs",
          sha256: "c".repeat(64),
        },
      },
    };
...
async function createFixture(): Promise<{
  ...
  const validator = "export function validate(){return []}";
