...
| `openclawConfig.sync.manifestUrl` | `string` | `https://raw.githubusercontent.com/nilsjorek/openclaw-config-vscode/main/schemas/live/manifest.json` | HTTPS URL | Use trusted, versioned manifest endpoints only. |
...
| `openclawConfig.sync.allowedRepositories` | `string[]` | `["nilsjorek/openclaw-config-vscode"]` | `owner/repo` values or `"*"` | Prefer explicit repositories. Use `"*"` only in controlled environments. |
...
```json
{
  ...
  "openclawConfig.sync.manifestUrl": "https://raw.githubusercontent.com/nilsjorek/openclaw-config-vscode/main/schemas/live/manifest.json",
  "openclawConfig.sync.allowedHosts": [
